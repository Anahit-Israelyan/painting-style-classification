...
![ResNet18 training curves](figures/09_resnet18_transfer_loss_curve.png)
...
![Nearest images to selected cluster centers](figures/44_nearest_images_to_selected_cluster_centers.png)
...
and are now saved in `reports/figures/`:
